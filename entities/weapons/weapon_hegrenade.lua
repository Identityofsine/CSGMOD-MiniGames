...
killicon.AddFont( "weapon_hegrenade", "CSKillIcons", "h", Color( 255, 80, 0, 255 ) )
killicon.AddFont( "hegrenade_projectile", "CSKillIcons", "h", Color( 255, 80, 0, 255 ) )
end
...
draw.SimpleText( "h", "CSSelectIcons", x + wide / 2, y + tall / 4, Color( 255, 220, 0, 255 ), TEXT_ALIGN_CENTER )
end
...
if SERVER then
local entity = ents.Create( "hegrenade_projectile" )
