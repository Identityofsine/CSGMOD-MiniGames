...
killicon.AddFont( "weapon_smokegrenade", "CSKillIcons", "Q", Color( 255, 80, 0, 255 ) )
killicon.AddFont( "smokegrenade_projectile", "CSKillIcons", "Q", Color( 255, 80, 0, 255 ) )
end
...
draw.SimpleText( "Q", "CSSelectIcons", x + wide / 2, y + tall / 4, Color( 255, 220, 0, 255 ), TEXT_ALIGN_CENTER )
end
...
if SERVER then
local entity = ents.Create( "smokegrenade_projectile" )
